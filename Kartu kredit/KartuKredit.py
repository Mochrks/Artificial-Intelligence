...
"""
Created 
@author: << Moch Rizki Kurniawan/3411191151-C >>
...
def langkah_1(jk,pd,bp,ku):
    ...
    if Hasil_True > Hasil_False :
        Hasil = 'True'
        print("Nilai Kartu kredit data inputan baru adalah")
...
#Dataset Penerima Kartu Kredit yang ada
...
#Inputan data/menerima masukan data(nilai)
JK = input("Jenis Kelamin :")
PD = input("Pendidikan :")
BP = input("Bidang Pekerjaan :")
KU = input("Kelompok Usia :")
